...
>>>>>>> 5f43431a0a8617a21da1a99748c7779d6a073bbe
...
| ![](<../../.gitbook/assets/global\_camera/image (52).png>) | ![](../../.gitbook/assets/global\_camera/image%20\(46\).png) |
| ![](<../../.gitbook/assets/global\_camera/image (53).png>) | ![](<../../.gitbook/assets/global\_camera/image (29).png>)   |
{% endtab %}
...
![](<../../.gitbook/assets/global\_camera/image (61).png>)

3. Save the settings and launch your viewer to verify if the change is applied successfully.

![](<../../.gitbook/assets/global\_camera/image (70).png>)
...
![](<../../.gitbook/assets/global\_camera/image (47).png>)
...
![](<../../.gitbook/assets/global\_camera/image (1).png>)
...
![](<../../.gitbook/assets/global\_camera/image (14).png>)

4. Save the settings and launch your viewer to verify if the change is applied successfully.

![](<../../.gitbook/assets/global\_camera/image (16).png>)

5. Here’s a comparison between images with different confidence threshold level.

| OWCT Level 1                                               | OWCT Level 2                                               | OWCT Level 3                                               |
| ---------------------------------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------- |
| ![](<../../.gitbook/assets/global\_camera/image (15).png>) | ![](<../../.gitbook/assets/global\_camera/image (48).png>) | ![](<../../.gitbook/assets/global\_camera/image (37).png>) |
| OWCT Level 4                                               | OWCT Level 5                                               | OWCT Level 6                                               |
| ![](<../../.gitbook/assets/global\_camera/image (49).png>) | ![](<../../.gitbook/assets/global\_camera/image (17).png>) | ![](<../../.gitbook/assets/global\_camera/image (20).png>) |
{% endtab %}
...
![](<../../.gitbook/assets/global\_camera/image (55).png>)
...
![](<../../.gitbook/assets/global\_camera/image (42).png>)
{% endtab %}
...
![](<../../.gitbook/assets/global\_camera/image (68).png>)

3\. Save the settings and launch your viewer to verify if the change is applied successfully.

![](<../../.gitbook/assets/global\_camera/image (11).png>)
{% endtab %}
{% endtabs %}
...
![](<../../.gitbook/assets/global\_camera/image (19).png>)
...
| ---------------------------------------------------------- | ---------------------------------------------------------- |
| ![](<../../.gitbook/assets/global\_camera/image (24).png>) | ![](<../../.gitbook/assets/global\_camera/image (50).png>) |
{% endtab %}
...
![](<../../.gitbook/assets/global\_camera/image (54).png>)
...
![](<../../.gitbook/assets/global\_camera/image (7).png>)
{% endtab %}
{% endtabs %}

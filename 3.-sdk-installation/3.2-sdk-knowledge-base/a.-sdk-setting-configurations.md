...
![](<../../.gitbook/assets/global_camera/image (6).png>)

3. Save the settings and launch your viewer to verify if the change is applied successfully.

<figure><img src="../../.gitbook/assets/global_camera/image (43).png" alt="" width="298"><figcaption></figcaption></figure>
...
| ![](<../../.gitbook/assets/global_camera/image (52).png>) | ![](<../../.gitbook/assets/global_camera/image (46).png>)          |
| ![](<../../.gitbook/assets/global_camera/image (53).png>) | ![](<../../.gitbook/assets/global_camera/image (29).png>)          |
{% endtab %}
...
<figure><img src="../../.gitbook/assets/global_camera/image (9).png" alt=""><figcaption></figcaption></figure>
...
![](<../../.gitbook/assets/global_camera/image (61).png>)

3. Save the settings and launch your viewer to verify if the change is applied successfully.

![](<../../.gitbook/assets/global_camera/image (70).png>)
...
![](<../../.gitbook/assets/global_camera/image (47).png>)

5.  Here’s a comparison between images with different levels of filter.

    | P0: 0.000002                                | P0: 0.000004                                | P0: 0.000008                                |
    | ------------------------------------------- | ------------------------------------------- | ------------------------------------------- |
    | ![](<../../.gitbook/assets/global_camera/image (32).png>) | ![](<../../.gitbook/assets/global_camera/image (26).png>) | ![](<../../.gitbook/assets/global_camera/image (41).png>) |
    | P0: 0.000016                                | P0: 0.000032                                | P0: 0.000064                                |
    | ![](<../../.gitbook/assets/global_camera/image (25).png>) | ![](<../../.gitbook/assets/global_camera/image (38).png>) | ![](<../../.gitbook/assets/global_camera/image (10).png>) |
{% endtab %}
...
![](<../../.gitbook/assets/global_camera/image (1).png>)
...
![](<../../.gitbook/assets/global_camera/image (16).png>)

5. Here’s a comparison between images with different confidence threshold level.

| OWCT Level 1                                | OWCT Level 2                                | OWCT Level 3                                |
| ------------------------------------------- | ------------------------------------------- | ------------------------------------------- |
| ![](<../../.gitbook/assets/global_camera/image (15).png>) | ![](<../../.gitbook/assets/global_camera/image (48).png>) | ![](<../../.gitbook/assets/global_camera/image (37).png>) |
| OWCT Level 4                                | OWCT Level 5                                | OWCT Level 6                                |
| ![](<../../.gitbook/assets/global_camera/image (49).png>) | ![](<../../.gitbook/assets/global_camera/image (17).png>) | ![](<../../.gitbook/assets/global_camera/image (20).png>) |
{% endtab %}
...
![](<../../.gitbook/assets/global_camera/image (55).png>)
...
![](<../../.gitbook/assets/global_camera/image (42).png>)
{% endtab %}
...
![](<../../.gitbook/assets/global_camera/image (68).png>)

3\. Save the settings and launch your viewer to verify if the change is applied successfully.

![](<../../.gitbook/assets/global_camera/image (11).png>)
{% endtab %}
{% endtabs %}
...
![](<../../.gitbook/assets/global_camera/image (19).png>)
...
| ------------------------------------------- | ------------------------------------------- |
| ![](<../../.gitbook/assets/global_camera/image (24).png>) | ![](<../../.gitbook/assets/global_camera/image (50).png>) |
{% endtab %}
...
![](<../../.gitbook/assets/global_camera/image (54).png>)
...
![](<../../.gitbook/assets/global_camera/image (7).png>)
{% endtab %}
{% endtabs %}
